...
`,o="https://esm.sh",s=["/App.tsx","/App.js","/App.jsx","/App.ts"],i=["",".tsx",".ts",".jsx",".js"],a=e=>/\.[jt]sx?$/.test(e),l=/(\bfrom\s*|\bimport\s*|\bimport\(\s*)(['"])(\.[^'"]*)\2/g,d=/^[^\S\n]*import\s+(['"])([^'"]+\.s?css)\1;?[^\S\n]*$/gm;class c extends Error{file;constructor(e,t){super(e),this.file=t,this.name="CompileError"}}let p=(e,t,r="")=>{let n=t[e];return`${o}/${e}${n?`@${encodeURIComponent(n)}`:""}${r}`},u=(e,t,r)=>{let n=t.slice(0,t.lastIndexOf("/")+1),o=new URL(e,`file://${n}`).pathname;for(let e of i)if(r[o+e])return o+e;throw new c(`Cannot resolve '${e}' from '${t}'`,t)},h=String.raw`
...
post('mounted');
`,m=e=>e.replaceAll("</",String.raw`<\/`),f=(e,t,r)=>{let i=s.find(t=>e[t]);if(!i)throw new c("No entry module. Expected /App.tsx or /App.js.");let f=((e,t)=>{let r={};for(let n of Object.values(e)){let o;if(!a(n.path))continue;let s=n.code.replaceAll(d,"");try{o=t(s,{transforms:["typescript","jsx"],jsxRuntime:"automatic",filePath:n.path}).code}catch(t){let{message:e}=t;throw new c(`${n.path}: ${e}`,n.path)}let i=[],p=o.replaceAll(l,(t,r,o,s)=>{let a=u(s,n.path,e);return i.push(a),`${r}${o}__RQBMOD:${a}__${o}`});r[n.path]={code:p,deps:i}}return r})(e,t),g=(e=>{let t=e.react??"18",r=e["react-dom"]??t,n={react:`${o}/react@${encodeURIComponent(t)}`,"react/":`${o}/react@${encodeURIComponent(t)}/`,"react-dom":`${o}/react-dom@${encodeURIComponent(r)}?external=react`,"react-dom/":`${o}/react-dom@${encodeURIComponent(r)}&external=react/`};for(let t of Object.keys(e))"react"!==t&&"react-dom"!==t&&(n[t]=p(t,e,"?external=react,react-dom"));return{imports:n}})(r.dependencies),y=((e,t)=>{let r=new Set(t.extraCSSImports);for(let t of Object.values(e))if(a(t.path))for(let[,,e]of t.code.matchAll(d))e.startsWith(".")||r.add(e);return[...r].map(e=>((e,t)=>{let r,n,[o,s]=(r=e.split("/"),[n=e.startsWith("@")?r.slice(0,2).join("/"):r[0],e.slice(n.length+1)]);return p(o,t,`/${s}`).replace(/\.scss$/,".css")})(e,t.dependencies))})(e,r),x=[n,...Object.values(e).filter(e=>{let t;return t=e.path,/\.s?css$/.test(t)}).map(e=>e.code)].filter(Boolean).join("\n\n");return`<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
</html>`}},52162(e,t,r){r.d(t,{b:()=>p});var n=r(62540),o=r(23392),s=r(34471),i=r(63696),a=r(94813);let l=/^\s*import\s+(['"])react-querybuilder\/dist\/query-builder\.s?css\1;?\s*$/m,d={"language-tsx":"/App.tsx","language-js":"/App.js","language-css":"/styles.css"},c=i.lazy(()=>Promise.all([r.e("24014"),r.e("36400"),r.e("79715")]).then(r.bind(r,63726)).then(e=>({default:e.LiveExample}))),p=({children:e,customSetup:t,rqbVersion:r=8})=>{let p="dark"===(0,s.G)().colorMode,{files:u,error:h}=i.useMemo(()=>(e=>{let t=i.Children.toArray(e),r=[];for(let e of t){let t,n=e?.props?.children?.props;if(!n||"string"!=typeof n.children)return{files:r,error:"Every child of SandpackRQB must be a code fence."};let o=!1,s=!1;if(n.metastring){let[e,...r]=n.metastring.split(" ");t="/"+e,o=r.includes("hidden"),s=r.includes("active")}else if(!(t=d[n.className??""]))return{files:r,error:`Code block is missing a filename: ${n.children}`};if(r.some(e=>e.path===t))return{files:r,error:`File ${t} was defined multiple times. Each file snippet should have a unique path name.`};r.push({path:t,code:n.children,lang:n.className?.replace("language-","")??"tsx",hidden:o,active:s})}return{files:r}})(e),[e]),m=i.useMemo(()=>({...t?.dependencies,"react-querybuilder":`^${r}`}),[t?.dependencies,r]),f=i.useMemo(()=>{let e=u.find(e=>a.ye.includes(e.path));return e&&l.test(e.code)?[]:["react-querybuilder/dist/query-builder.css"]},[u]);return(0,n.jsx)("div",{className:"sandpackrqb",children:(0,n.jsx)(o.A,{children:()=>(0,n.jsx)(i.Suspense,{fallback:null,children:(0,n.jsx)(c,{files:u,dependencies:m,extraCSSImports:f,parseError:h,dark:p})})})},`v${r}`)}},43023(e,t,r){r.d(t,{R:()=>i,x:()=>a});var n=r(63696);let o={},s=n.createContext(o);function i(e){let t=n.useContext(s);return n.useMemo(function(){return"function"==typeof e?e(t):{...t,...e}},[t,e])}function a(e){let t;return t=e.disableParentContext?"function"==typeof e.components?e.components(o):e.components||o:i(e.components),n.createElement(s.Provider,{value:t},e.children)}}}]);