...
`,a="https://esm.sh",o=["/App.tsx","/App.js","/App.jsx","/App.ts"],i=["",".tsx",".ts",".jsx",".js"],s=e=>/\.[jt]sx?$/.test(e),l=/(\bfrom\s*|\bimport\s*|\bimport\(\s*)(['"])(\.[^'"]*)\2/g,d=/^[^\S\n]*import\s+(['"])([^'"]+\.s?css)\1;?[^\S\n]*$/gm;class p extends Error{file;constructor(e,t){super(e),this.file=t,this.name="CompileError"}}let c=(e,t,r="")=>{let n=t[e];return`${a}/${e}${n?`@${encodeURIComponent(n)}`:""}${r}`},u=(e,t,r)=>{let n=t.slice(0,t.lastIndexOf("/")+1),a=new URL(e,`file://${n}`).pathname;for(let e of i)if(r[a+e])return a+e;throw new p(`Cannot resolve '${e}' from '${t}'`,t)},h=String.raw`
