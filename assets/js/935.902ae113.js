...
const H = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiDivider", ["root", "absolute", "fullWidth", "inset", "middle", "flexItem", "light", "vertical", "withChildren", "withChildrenVertical", "textAlignRight", "textAlignLeft", "wrapper", "wrapperVertical"]), O = H, W = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiListItemIcon", ["root", "alignItemsFlexStart"]), T = W, z = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiListItemText", ["root", "multiline", "dense", "inset", "primary", "secondary"]), N = z;
function A(e) {
  return (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.g)("MuiMenuItem", e);
}
const q = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiMenuItem", ["root", "focusVisible", "dense", "disabled", "divider", "gutters", "selected"]), r = q, J = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"], K = (e, s) => {
  const {
    ownerState: o
  } = e;
  ...
  const {
    ...
    selected: m,
    classes: i
  } = e, n = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.h)({
    root: ["root", o && "dense", s && "disabled", !c && "gutters", a && "divider", m && "selected"]
  }, A, i);
  return (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, i, n);
}, X = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(_ButtonBase_84669fa3_mjs__WEBPACK_IMPORTED_MODULE_5__.B, {
  ...
  [`&.${r.selected}`]: {
    backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / ${e.vars.palette.action.selectedOpacity})` : (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity),
    [`&.${r.focusVisible}`]: {
      backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / calc(${e.vars.palette.action.selectedOpacity} + ${e.vars.palette.action.focusOpacity}))` : (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity + e.palette.action.focusOpacity)
    }
  },
  [`&.${r.selected}:hover`]: {
    backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / calc(${e.vars.palette.action.selectedOpacity} + ${e.vars.palette.action.hoverOpacity}))` : (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity + e.palette.action.hoverOpacity),
    // Reset on touch devices, it doesn't add specificity
    "@media (hover: none)": {
      backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / ${e.vars.palette.action.selectedOpacity})` : (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity)
    }
...
}, s.dense && (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
  minHeight: 32,
  ...
  const a = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.u)({
    ...
    tabIndex: v,
    className: w
  } = a, L = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(a, J), y = react__WEBPACK_IMPORTED_MODULE_1__.useContext(_ListContext_de5072f9_mjs__WEBPACK_IMPORTED_MODULE_3__.L), C = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => ({
    dense: i || y.dense || !1,
    disableGutters: n
  ...
  const B = (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, a, {
    dense: C.dense,
    divider: g,
    disableGutters: n
  ...
  return a.disabled || (I = v !== void 0 ? v : -1), /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_ListContext_de5072f9_mjs__WEBPACK_IMPORTED_MODULE_3__.L.Provider, {
    value: C,
    children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(X, (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
      ref: E,
      role: k,
      tabIndex: I,
      component: m,
      focusVisibleClassName: (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(f.focusVisible, R),
      className: (0,_useThemeProps_e46212c4_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(f.root, w)
    }, L, {
      ownerState: B,
      classes: f
    }))
...
//# sourceMappingURL=index-55da56fa.mjs.map
