...
function X(o) {
  return (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.g)("MuiFormControl", o);
}
const Y = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiFormControl", ["root", "marginNone", "marginNormal", "marginDense", "fullWidth", "disabled"]), de = Y, Z = ["children", "className", "color", "component", "disabled", "error", "focused", "fullWidth", "hiddenLabel", "margin", "required", "size", "variant"], ee = (o) => {
  const {
    classes: s,
    margin: a,
    fullWidth: l
  } = o, n = {
    root: ["root", a !== "none" && `margin${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(a)}`, l && "fullWidth"]
  };
  return (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.h)(n, X, s);
}, oe = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("div", {
  name: "MuiFormControl",
  slot: "Root",
  overridesResolver: ({
    ownerState: o
  }, s) => (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, s.root, s[`margin${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(o.margin)}`], o.fullWidth && s.fullWidth)
})(({
  ownerState: o
  ...
  const l = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.u)({
    ...
    size: F = "medium",
    variant: y = "outlined"
  } = l, R = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(l, Z), v = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, l, {
    color: m,
    component: f,
    disabled: p,
    error: x,
  ...
  return /* @__PURE__ */ (0,_index_cb6635f1_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(_useFormControl_6c63a0c0_mjs__WEBPACK_IMPORTED_MODULE_3__.F.Provider, {
    value: $,
    children: /* @__PURE__ */ (0,_index_cb6635f1_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(oe, (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
      as: f,
      ownerState: v,
      className: (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(_.root, I),
      ref: a
    }, R, {
      children: n
    }))
...
//# sourceMappingURL=index.bcf93858.mjs.map
