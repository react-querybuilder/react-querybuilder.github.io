...
/* harmony import */ var _ButtonBase_3fc6bf76_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(13184);
...
/* harmony import */ var _useForkRef_659eae06_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(55461);
/* harmony import */ var _useControlled_c2328b4a_mjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(98993);
/* harmony import */ var react_querybuilder__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(75611);
...
function N(o) {
  return (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.g)("MuiSwitch", o);
}
const I = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiSwitch", ["root", "edgeStart", "edgeEnd", "switchBase", "colorPrimary", "colorSecondary", "sizeSmall", "sizeMedium", "checked", "disabled", "input", "thumb", "track"]), s = I, _ = ["className", "color", "edge", "size", "sx"], D = (o) => {
  const {
    classes: e,
    edge: r,
    size: c,
    ...
    root: ["root", r && `edge${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r)}`, `size${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(c)}`],
    switchBase: ["switchBase", `color${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(d)}`, u && "checked", h && "disabled"],
    thumb: ["thumb"],
    track: ["track"],
    input: ["input"]
  }, x = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.h)(g, N, e);
  return (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, e, x);
}, P = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("span", {
  name: "MuiSwitch",
  slot: "Root",
  overridesResolver: (o, e) => {
    ...
    return [e.root, r.edge && e[`edge${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r.edge)}`], e[`size${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r.size)}`]];
  }
})(({
  ownerState: o
}) => (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
...
})), U = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(_SwitchBase_f05dcdbd_mjs__WEBPACK_IMPORTED_MODULE_3__.S, {
  name: "MuiSwitch",
  slot: "SwitchBase",
  overridesResolver: (o, e) => {
    const {
    ...
    return [e.switchBase, {
      [`& .${s.input}`]: e.input
    }, r.color !== "default" && e[`color${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r.color)}`]];
  }
})(({
  theme: o
}) => ({
  ...
  "&:hover": {
    backgroundColor: o.vars ? `rgba(${o.vars.palette.action.activeChannel} / ${o.vars.palette.action.hoverOpacity})` : (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(o.palette.action.active, o.palette.action.hoverOpacity),
    "@media (hover: none)": {
      backgroundColor: "transparent"
    }
  }
  ...
  [`&.${s.checked}`]: {
    ...
    "&:hover": {
      backgroundColor: o.vars ? `rgba(${o.vars.palette[e.color].mainChannel} / ${o.vars.palette.action.hoverOpacity})` : (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(o.palette[e.color].main, o.palette.action.hoverOpacity),
      "@media (hover: none)": {
        backgroundColor: "transparent"
      }
    },
    [`&.${s.disabled}`]: {
      color: o.vars ? o.vars.palette.Switch[`${e.color}DisabledColor`] : `${o.palette.mode === "light" ? (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.w)(o.palette[e.color].main, 0.62) : (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.x)(o.palette[e.color].main, 0.55)}`
    }
  },
  [`&.${s.checked} + .${s.track}`]: {
    backgroundColor: (o.vars || o).palette[e.color].main
  }
})), E = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("span", {
  name: "MuiSwitch",
  slot: "Track",
...
})), A = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("span", {
  name: "MuiSwitch",
  slot: "Thumb",
  ...
  const c = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.u)({
    ...
    size: g = "medium",
    sx: x
  } = c, w = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(c, _), n = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, c, {
    color: u,
    edge: h,
    size: g
  }), l = D(n), f = /* @__PURE__ */ (0,_index_cb6635f1_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(A, {
    className: l.thumb,
    ownerState: n
  });
  return /* @__PURE__ */ (0,_index_cb6635f1_mjs__WEBPACK_IMPORTED_MODULE_4__.a)(P, {
    className: (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(l.root, d),
    sx: x,
    ownerState: n,
    children: [/* @__PURE__ */ (0,_index_cb6635f1_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(U, (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
      type: "checkbox",
      icon: f,
      checkedIcon: f,
      ref: r,
      ...
      classes: (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, l, {
        root: l.switchBase
      })
    })), /* @__PURE__ */ (0,_index_cb6635f1_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(E, {
      className: l.track,
      ownerState: n
    })]
  });
...
//# sourceMappingURL=index.6893349e.mjs.map
