...
/* harmony import */ var react_querybuilder__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(75611);
...
function T(s) {
  return (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.g)("MuiListSubheader", s);
}
const j = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiListSubheader", ["root", "colorPrimary", "colorInherit", "gutters", "inset", "sticky"]), W = j, G = ["className", "color", "component", "disableGutters", "disableSticky", "inset"], N = (s) => {
  const {
    classes: t,
    color: o,
    disableGutters: r,
    ...
    root: ["root", o !== "default" && `color${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(o)}`, !r && "gutters", a && "inset", !l && "sticky"]
  };
  return (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.h)(i, T, t);
}, M = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("li", {
  ...
  overridesResolver: (s, t) => {
    ...
    return [t.root, o.color !== "default" && t[`color${(0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(o.color)}`], !o.disableGutters && t.gutters, o.inset && t.inset, !o.disableSticky && t.sticky];
  }
})(({
  theme: s,
  ownerState: t
  ...
  const r = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.u)({
    ...
    disableSticky: b = !1,
    inset: f = !1
  } = r, y = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(r, G), c = (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, r, {
    color: l,
    component: i,
    disableGutters: u,
    disableSticky: b,
  ...
  return /* @__PURE__ */ (0,_index_cb6635f1_mjs__WEBPACK_IMPORTED_MODULE_3__.j)(M, (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
    as: i,
    className: (0,_useThemeProps_8eb5b3fc_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(x.root, a),
    ref: o,
    ownerState: c
  }, y));
});
...
//# sourceMappingURL=index.86c62ee5.mjs.map
