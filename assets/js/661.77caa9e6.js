...
/* harmony import */ var _useFormControl_6c63a0c0_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(31099);
/* harmony import */ var _ButtonBase_b93f9ef5_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(89834);
/* harmony import */ var _TransitionGroupContext_1471c9f6_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(19329);
/* harmony import */ var _useIsFocusVisible_4fedb338_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(87290);
/* harmony import */ var _useEventCallback_3a06ade6_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(65555);
/* harmony import */ var _useEnhancedEffect_cb67364c_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(99691);
/* harmony import */ var _elementTypeAcceptingRef_c716dab8_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(51486);
/* harmony import */ var _useForkRef_ba4bec2f_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(46206);
/* harmony import */ var _useControlled_c2328b4a_mjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(98993);
/* harmony import */ var react_querybuilder__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(87504);
...
function N(o) {
  return (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.g)("MuiSwitch", o);
}
const I = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiSwitch", ["root", "edgeStart", "edgeEnd", "switchBase", "colorPrimary", "colorSecondary", "sizeSmall", "sizeMedium", "checked", "disabled", "input", "thumb", "track"]), s = I, _ = ["className", "color", "edge", "size", "sx"], D = (o) => {
  const {
    classes: e,
    edge: r,
    size: c,
    ...
    root: ["root", r && `edge${(0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r)}`, `size${(0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(c)}`],
    switchBase: ["switchBase", `color${(0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(d)}`, u && "checked", h && "disabled"],
    thumb: ["thumb"],
    track: ["track"],
    input: ["input"]
  }, x = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.h)(g, N, e);
  return (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, e, x);
}, P = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("span", {
  name: "MuiSwitch",
  slot: "Root",
  overridesResolver: (o, e) => {
    ...
    return [e.root, r.edge && e[`edge${(0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r.edge)}`], e[`size${(0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r.size)}`]];
  }
})(({
  ownerState: o
}) => (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
...
})), U = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(_SwitchBase_4b624bde_mjs__WEBPACK_IMPORTED_MODULE_3__.S, {
  name: "MuiSwitch",
  slot: "SwitchBase",
  overridesResolver: (o, e) => {
    const {
    ...
    return [e.switchBase, {
      [`& .${s.input}`]: e.input
    }, r.color !== "default" && e[`color${(0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.c)(r.color)}`]];
  }
})(({
  theme: o
}) => ({
  ...
  "&:hover": {
    backgroundColor: o.vars ? `rgba(${o.vars.palette.action.activeChannel} / ${o.vars.palette.action.hoverOpacity})` : (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(o.palette.action.active, o.palette.action.hoverOpacity),
    "@media (hover: none)": {
      backgroundColor: "transparent"
    }
  }
  ...
  [`&.${s.checked}`]: {
    ...
    "&:hover": {
      backgroundColor: o.vars ? `rgba(${o.vars.palette[e.color].mainChannel} / ${o.vars.palette.action.hoverOpacity})` : (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(o.palette[e.color].main, o.palette.action.hoverOpacity),
      "@media (hover: none)": {
        backgroundColor: "transparent"
      }
    },
    [`&.${s.disabled}`]: {
      color: o.vars ? o.vars.palette.Switch[`${e.color}DisabledColor`] : `${o.palette.mode === "light" ? (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.w)(o.palette[e.color].main, 0.62) : (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.x)(o.palette[e.color].main, 0.55)}`
    }
  },
  [`&.${s.checked} + .${s.track}`]: {
    backgroundColor: (o.vars || o).palette[e.color].main
  }
})), E = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("span", {
  name: "MuiSwitch",
  slot: "Track",
...
})), A = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.s)("span", {
  name: "MuiSwitch",
  slot: "Thumb",
  ...
  const c = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.u)({
    props: e,
    name: "MuiSwitch"
  }), {
    className: d,
    ...
    size: g = "medium",
    sx: x
  } = c, w = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(c, _), n = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, c, {
    color: u,
    edge: h,
    size: g
  }), l = D(n), f = /* @__PURE__ */ (0,_index_82f04b83_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(A, {
    className: l.thumb,
    ownerState: n
  });
  return /* @__PURE__ */ (0,_index_82f04b83_mjs__WEBPACK_IMPORTED_MODULE_4__.a)(P, {
    className: (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(l.root, d),
    sx: x,
    ownerState: n,
    children: [/* @__PURE__ */ (0,_index_82f04b83_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(U, (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
      type: "checkbox",
      icon: f,
      checkedIcon: f,
      ref: r,
      ...
      classes: (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, l, {
        root: l.switchBase
      })
    })), /* @__PURE__ */ (0,_index_82f04b83_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(E, {
      className: l.track,
      ownerState: n
    })]
  });
...
//# sourceMappingURL=index.8264d9a1.mjs.map
