...
/* harmony import */ var react_querybuilder__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(87504);
...
const H = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiDivider", ["root", "absolute", "fullWidth", "inset", "middle", "flexItem", "light", "vertical", "withChildren", "withChildrenVertical", "textAlignRight", "textAlignLeft", "wrapper", "wrapperVertical"]), M = H, W = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiListItemIcon", ["root", "alignItemsFlexStart"]), O = W, z = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiListItemText", ["root", "multiline", "dense", "inset", "primary", "secondary"]), T = z;
function A(e) {
  return (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.g)("MuiMenuItem", e);
}
const q = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.a)("MuiMenuItem", ["root", "focusVisible", "dense", "disabled", "divider", "gutters", "selected"]), r = q, J = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"], K = (e, s) => {
  const {
    ownerState: o
  } = e;
  ...
  const {
    ...
    selected: u,
    classes: l
  } = e, c = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.h)({
    root: ["root", o && "dense", s && "disabled", !n && "gutters", a && "divider", u && "selected"]
  }, A, l);
  return (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, l, c);
}, X = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.s)(_ButtonBase_b93f9ef5_mjs__WEBPACK_IMPORTED_MODULE_5__.B, {
  ...
  theme: e,
  ownerState: s
}) => (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, e.typography.body1, {
  display: "flex",
  ...
  [`&.${r.selected}`]: {
    backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / ${e.vars.palette.action.selectedOpacity})` : (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity),
    [`&.${r.focusVisible}`]: {
      backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / calc(${e.vars.palette.action.selectedOpacity} + ${e.vars.palette.action.focusOpacity}))` : (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity + e.palette.action.focusOpacity)
    }
  },
  [`&.${r.selected}:hover`]: {
    backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / calc(${e.vars.palette.action.selectedOpacity} + ${e.vars.palette.action.hoverOpacity}))` : (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity + e.palette.action.hoverOpacity),
    "@media (hover: none)": {
      backgroundColor: e.vars ? `rgba(${e.vars.palette.primary.mainChannel} / ${e.vars.palette.action.selectedOpacity})` : (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(e.palette.primary.main, e.palette.action.selectedOpacity)
    }
  },
...
}, s.dense && (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
  minHeight: 32,
  paddingTop: 4,
  paddingBottom: 4
}, e.typography.body2, {
...
}))), N = /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(function(s, o) {
  const a = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.u)({
    props: s,
    name: "MuiMenuItem"
  }), {
    autoFocus: n = !1,
    ...
    tabIndex: g,
    className: k
  } = a, w = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(a, J), L = react__WEBPACK_IMPORTED_MODULE_1__.useContext(_ListContext_5c78d929_mjs__WEBPACK_IMPORTED_MODULE_3__.L), v = {
    dense: l || L.dense || !1,
    disableGutters: c
  ...
  const B = (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({}, a, {
    dense: v.dense,
    divider: x,
    disableGutters: c
  }), b = Q(a), j = (0,_useForkRef_ba4bec2f_mjs__WEBPACK_IMPORTED_MODULE_7__.u)(m, o);
  let y;
  return a.disabled || (y = g !== void 0 ? g : -1), /* @__PURE__ */ (0,_index_82f04b83_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(_ListContext_5c78d929_mjs__WEBPACK_IMPORTED_MODULE_3__.L.Provider, {
    value: v,
    children: /* @__PURE__ */ (0,_index_82f04b83_mjs__WEBPACK_IMPORTED_MODULE_4__.j)(X, (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__._)({
      ref: j,
      role: R,
      tabIndex: y,
      component: u,
      focusVisibleClassName: (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(b.focusVisible, V),
      className: (0,_useThemeProps_504db37e_mjs__WEBPACK_IMPORTED_MODULE_0__.f)(b.root, k)
    }, w, {
      ownerState: B,
      classes: b
    }))
...
//# sourceMappingURL=index.a4e4b973.mjs.map
