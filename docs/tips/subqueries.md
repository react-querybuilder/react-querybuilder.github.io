...
| Partial[2](#user-content-fn-2) | "sql", "parameterized", "drizzle"                                                                                  |
| None                           | "parameterized\_named"[3](#user-content-fn-3), "prisma", "sequelize", "elasticsearch", "ldap"                      |
...
2. SQL-based formats only support primitive value arrays when `preset` is "postgresql". Other RDBMS platforms lack support for nested tables or have overly complex implementations. [↩](#user-content-fnref-2)

3. PostgreSQL does not support named parameters [↩](#user-content-fnref-3)
