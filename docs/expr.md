...
`expressionParserSpEL` is the ready-to-use handler for [`parseSpEL`](/docs/utils/import.md#spring-expression-language-spel), bound to the built-in SpEL inverse. It handles infix arithmetic operands:
